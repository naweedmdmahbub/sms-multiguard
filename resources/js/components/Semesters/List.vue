...
<template>
    <div style="padding: 10px;">
        ...
        <el-dialog
            :title="formTitle"
            v-model="dialogAssignStudentVisible"
        >
            <assign-student-form
...
import AssignStudentForm from './AssignStudentForm.vue';

export default {
    name: 'SemesterList',
    components: { FormComponent, AssignStudentForm },
    data() {
        return {
            semesters: [],
            logged_in_user: null,
    ...
    methods: {
        ...
        async getList() {
            ...
            await axios.get(`/api/semesters`, {params}).
                    then((res) => {
                        console.log('res:', res);
        ...
        handleEdit(id){
            console.log('List in handleEdit', this.semesters);
            this.currentSemester = this.semesters.find(semester => semester.id === id);
            this.mode = 'edit';
